...
function Filters2() {
  ...
  console.log(optionOrderByPriceOrRating);
  return (
    <VStack>
      <Box width="50%" minWidth="200px" borderRadius="40%">
        ...
        >
          {optionsIngredients?.map((ingredient) => (
            <option>{ingredient.label}</option>
          ))}
        </Select>
        <Spacer />
      </Box>
      ...
      >
        ...
        >
          {optionOrderByPriceOrRating?.map((price) => (
        ...
        >
          {optionOrderByPriceOrRating?.map((rating) => (
            <option>{rating.label}</option>
          ))}
        </Select>
      </Box>
    </VStack>
